<?php 
	...
	if (isset($_GET['id']) && $_GET['id'] != '') {
		...
		<form action="" id="news_form" name="news_form" method="POST" enctype="multipart/form-data">
			...
			<input type="text" id="title" name="title" placeholder="Mercedes News title.." required>

			<label for="description">Description *</label>
			<textarea id="description" name="description" placeholder="Mercedes News description.." required></textarea>
		...
		<form action="" id="news_form_edit" name="news_form_edit" method="POST" enctype="multipart/form-data">
			...
			<label for="title">Title *</label>
			<input type="text" id="title" name="title" value="' . $row['title'] . '" placeholder="Mercedes News title.." required>

			<label for="description">Description *</label>
			<textarea id="description" name="description" placeholder="Mercedes News description.." required>' . $row['description'] . '</textarea>
